...
public class ServicioSoporte {
    ...
    public void cargarSoportes(String archivo) throws FileNotFoundException, LibroException, SoporteException, DVDException, CDException{
    ...
    public Soporte buscarMaterial(String busqueda, ArrayList<Soporte> soportes){
      Soporte materialEncontrado = null;
      for(int i=0; i<soportes.size(); i++){
        if(busqueda.equals(soportes.get(i).getTitulo())){
          materialEncontrado=soportes.get(i);
        }    
      }
   ...
   public void PrestarMaterial(Soporte soporte){
     soporte.setPrestado(true);
   }
